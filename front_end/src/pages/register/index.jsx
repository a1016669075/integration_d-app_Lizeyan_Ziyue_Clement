    ...
    render() {
        ...
        return (
            <div className="register-page">
                ...
                <WingBlank>
                    <List>
                        <InputItem value={username} placeholder='Please enter a user name' onChange={val => this.handleChange('username', val)}>The user name:</InputItem>
                        <InputItem value={password} placeholder='Please enter your password' type="password" onChange={val => this.handleChange('password', val)}>Dense &nbsp; &nbsp; &nbsp; &nbsp; code:</InputItem>
                        <InputItem value={password2} placeholder='Please confirm your password' type="password" onChange={val => this.handleChange('password2', val)}>Confirm password:</InputItem>
                        <ListItem>

...
class LaobanInfo extends Component {
    ...
    save = () => {
        const {header,post,info,company,salary,id} = this.state
        if(!header){
    ...
    render() {
        ...
        return (
            <div>
                ...
                <InputItem onChange={val => this.handleChange('company', val)}>Entreprise:</InputItem>
                <InputItem onChange={val => this.handleChange('salary', val)}>Salaire:</InputItem>
                <TextareaItem
                    title='Services:'
                    rows={3}
